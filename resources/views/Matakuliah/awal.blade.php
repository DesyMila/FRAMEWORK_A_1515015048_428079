		...
		<tbody>
			...
			<tr>
				...
				<td><div class="btn-group" role="group">
					...
					<a href="{{url(dosen_matakuliah/hapus/'.$dosen_matakuliaha->id" class="btn btn-danger btn-xs" data-toggle="tooltip" data-placement="top" title="Hapus"><i class fa fa-remote></i></a>
				</div>
				</td>
			</tr>
			@endforeach
